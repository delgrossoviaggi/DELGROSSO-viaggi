...
(() => {
  ...
  const ROUTES = {
    ...
    checkin:'./checkin.html', statistiche:'./statistiche.html', centrooperativo:'./centro-operativo.html', noleggibus:'./noleggi-bus.html', impostazioni:'./impostazioni.html'
  };
  const NAV = [
    ...
    ['CHECK-IN','checkin','⌗'], ['Statistiche','statistiche','▥'], ['Centro Operativo','centrooperativo','◉'], ['Noleggi Bus','noleggibus','🚌'], ['Impostazioni','impostazioni','⚙']
  ];
  const TITLES = {
    ...
    checkin:'CHECK-IN',statistiche:'Statistiche',centrooperativo:'Centro Operativo',noleggibus:'Noleggi Bus',impostazioni:'Impostazioni'
  };
  ...
  function build() {
    ...
    shell.innerHTML = `
      ...
      <header class="dg-v41-header" role="banner">
        ...
        <div class="dg-v41-status" aria-label="DELGROSSO Viaggi & Limousine Bus"><span class="dg-v41-dot"></span><div class="dg-v41-marquee" title="DELGROSSO VIAGGI & LIMOUSINE BUS"><div class="dg-v41-marquee-track"><span>DELGROSSO VIAGGI <b>&amp;</b> LIMOUSINE BUS</span><span aria-hidden="true">DELGROSSO VIAGGI <b>&amp;</b> LIMOUSINE BUS</span></div></div></div>
      </header>
