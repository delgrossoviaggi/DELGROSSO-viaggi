    ...
    <aside class="dg-brand-shell__sidebar">
      <div class="dg-brand-shell__sidebar-top">
        <div class="dg-brand-shell__brand">
          <img src="${c.logo||``+new URL(`logo-BKhzXkqO.JPEG`,import.meta.url).href}" alt="${c.name}" />
          <div>
