/* DEL GROSSO GESTIONALE — SYNC BUILD 154 */
const CACHE=`dg-gestionale-sync-154`;
...
const PRECACHE=[
 ...
 `assets/dg-supabase-sync-v4.js`,`assets/settingsService-SYNC153.js`,`assets/prenotazioni-SYNC154.js`,`manifest.json`
];
